...
import com.example.uts.databinding.ActivityMateriBinding
...
class Materi : AppCompatActivity() {
    ...
    private fun setupRecyclerView() {
        val listMateri = getDummyData()
        val adapter = MateriAdapter(listMateri) { materi ->
            // Pindah ke DetailMateriActivity
    ...
    private fun getDummyData(): List<MateriModel> {
        return listOf(
            MateriModel(
                "HTML",
